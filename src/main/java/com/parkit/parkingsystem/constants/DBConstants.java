...
public class DBConstants {
    ...
    public static final String GET_NUMBERS_TICKETS_BY_VEHICLE_REG_NUMBER = "SELECT COUNT(*) FROM `ticket` WHERE `ticket`.`VEHICLE_REG_NUMBER` = ? AND `ticket`.`OUT_TIME` IS NOT NULL";
}
